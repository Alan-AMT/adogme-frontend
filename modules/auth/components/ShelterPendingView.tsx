    ...
    <div className="min-h-screen bg-[#f4f6f9] flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-10">
        <div className="w-full max-w-lg flex flex-col gap-6">
          {/* ── Card principal ── */}
          <div
            className="bg-white rounded-[24px] p-6 sm:p-8 flex flex-col gap-6"
            style={{
              boxShadow:
          ...
          >
            ...
            <div className="flex flex-col items-center text-center gap-3">
              ...
              <div>
                ...
                <p className="text-[14px] text-[#6b7280] leading-relaxed">
                  La solicitud de{" "}
                  <strong className="text-[#111827]">{shelterName}</strong> está
            ...
            >
              ...
              <div>
                <p className="text-[13px] font-[900] text-[#1d4ed8]">
            ...
            <div className="flex flex-col gap-2">
              ...
              {[
                {
                  icon: "pets",
                  label: "Explorar el catálogo de perros",
                  href: "/perros",
                },
                {
                  icon: "home_work",
                  label: "Ver otros refugios verificados",
                  href: "/refugios",
                },
              ].map((item) => (
                <Link
                ...
                >
                  ...
                  {item.label}
                  <span
                    className="material-symbols-outlined ml-auto text-[#d4d4d8]"
                    style={{ fontSize: 16 }}
                  >
                    chevron_right
                  </span>
          ...
          {/* ── Card de soporte ── */}
          <div
            className="bg-white rounded-[20px] p-5 flex flex-col gap-3"
          ...
          >
            ...
            <p className="text-[13px] font-[700] text-[#6b7280]">
              Contáctanos directamente y te ayudamos con el proceso de
              verificación.
            </p>
            <div className="flex flex-col gap-2">
              {SUPPORT.map((item) => (
                <div
                  key={item.label}
                  className="flex items-center gap-2.5 text-[13px] font-[800] text-[#374151]"
                >
                  <span
