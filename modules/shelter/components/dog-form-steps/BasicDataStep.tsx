    ...
    <>
      ...
      <div className="sv-form-section">
        ...
        <div className="sv-form-section__body">
          <div className="sv-form-row">
            <div className="sv-field">
              <label className="sv-field__label">
                Nombre <span className="sv-field__required">*</span>
              </label>
              <input
                type="text"
              ...
              />
              {errors.nombre && (
                <p className="sv-field__error">{errors.nombre}</p>
              )}
            </div>
            <div className="sv-field">
              <label className="sv-field__label">
          ...
          <div className="sv-form-row">
            <div className="sv-field">
              <label className="sv-field__label">
                Edad (meses) <span className="sv-field__required">*</span>
              </label>
              <input
                type="number"
                className="sv-field__input"
              ...
              />
              {formData.edad > 0 && (
                <p className="sv-field__helper">{formatAge(formData.edad)}</p>
              )}
      ...
      <div className="sv-form-section">
        ...
        <div className="sv-form-section__body">
          <div className="sv-field">
            <label className="sv-field__label">
              Sexo <span className="sv-field__required">*</span>
            </label>
            <div
              style={{
                display: "flex",
            ...
            >
              {SEXES.map((s) => (
                <button
                  key={s.value}
                  type="button"
                  onClick={() => update("sexo", s.value)}
                  style={pill(formData.sexo === s.value)}
                >
                  <span
          ...
          <div className="sv-field">
            ...
            >
              {SIZES.map((s) => (
                <button
                  key={s.value}
                  type="button"
                  onClick={() => update("tamano", s.value)}
                  style={pill(formData.tamano === s.value)}
                >
                  {s.label}
            ...
            {errors.tamano && (
              <p className="sv-field__error">{errors.tamano}</p>
            )}
          </div>

          <div className="sv-field">
            <label className="sv-field__label">
              Nivel de energía <span className="sv-field__required">*</span>
            </label>
            <div
              style={{
                display: "flex",
            ...
            >
              {ENERGIES.map((e) => (
                <button
                  key={e.value}
                  type="button"
                  onClick={() => update("nivelEnergia", e.value)}
                  style={pill(formData.nivelEnergia === e.value)}
                >
                  <span
                    className="material-symbols-outlined"
                    style={{ fontSize: 15 }}
            ...
            {errors.nivelEnergia && (
              <p className="sv-field__error">{errors.nivelEnergia}</p>
            )}
          </div>
        </div>
      </div>
      ...
      <div className="sv-form-section">
        ...
        <div className="sv-form-section__body">
          <div className="sv-field">
            <label className="sv-field__label">
              Descripción <span className="sv-field__required">*</span>
            </label>
            <textarea
