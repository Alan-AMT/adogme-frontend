...
export const MOCK_RECOMMENDATIONS: DogRecommendation[] = MOCK_DOGS
  ...
  .map((dog, i) => ({
    ...
    razonesMatch: [
      { categoria: 'activity',   texto: 'Tu nivel de actividad es compatible',    esPositivo: true  },
      { categoria: 'housing',    texto: 'El espacio en tu hogar es adecuado',      esPositivo: true  },
      { categoria: 'experience', texto: 'Tu experiencia previa es un plus',        esPositivo: true  },
      { categoria: 'care',       texto: 'Estás preparado para sus necesidades',    esPositivo: true  },
    ],
