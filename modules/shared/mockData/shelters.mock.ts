...
export const MOCK_SHELTERS: Shelter[] = [
  {
    ...
    descripcion:
      "Somos el refugio más grande de la GAM. Rescatamos perros desde 2012. Más de 800 adopciones exitosas. Trabajamos con voluntarios cada fin de semana.",
    ...
    donationConfig: {
      ...
      descripcionCausa:
        "Cada donación cubre alimento, veterinario y cuidados de 10 perros por una semana.",
  ...
  },
  {
    ...
    descripcion:
      "Refugio familiar con enfoque en rehabilitación de perros con trauma. Equipo de conductistas certificados en Coyoacán. Cada perro tiene un plan de socializacion individual.",
    ...
    donationConfig: {
      aceptaDonaciones: true,
      descripcionCausa:
        "Financiamos sesiones de conductismo para perros rescatados de maltrato.",
  ...
  },
  {
    ...
    descripcion:
      "El refugio más activo de Iztapalapa. Especializados en razas medianas y grandes. Proceso de adopción riguroso que garantiza adopciones exitosas y duraderas.",
    ...
    alcaldia: "Iztapalapa",
    direccionCompleta:
      "Col. Santa Martha Acatitla, Iztapalapa, Ciudad de México",
    ...
    donationConfig: {
      aceptaDonaciones: true,
      descripcionCausa:
        "Construimos nuevas instalaciones para tener más espacio y mejores condiciones.",
  ...
  },
  {
    ...
    descripcion:
      "Nació en 2018 como proyecto comunitario en la colonia Pedregal de San Nicolás. Hoy somos autosustentables gracias a nuestra red de 200 voluntarios activos en Tlalpan.",
    ...
    alcaldia: "Tlalpan",
    direccionCompleta:
      "Col. Pedregal de San Nicolás, Tlalpan, Ciudad de México",
    ...
    donationConfig: {
      aceptaDonaciones: true,
      descripcionCausa:
        "Ayuda a pagar veterinario, vacunas y esterilizaciones de nuestra comunidad.",
  ...
  },
  {
    ...
    descripcion:
      "Rescatamos perros callejeros de la colonia Del Valle y sus alrededores. Colaboramos con otras organizaciones de la CDMX para garantizar adopciones responsables.",
    ...
    donationConfig: {
      aceptaDonaciones: true,
      descripcionCausa:
        "Financiamos transporte, documentación y trámites de adopción internacional.",
...
export const MOCK_PENDING_SHELTERS: Shelter[] = [
  {
    ...
    descripcion:
      "Nuevo refugio en Azcapotzalco. Operamos desde hace 6 meses de forma informal y ahora queremos formalizarnos en la plataforma.",
  ...
  },
  {
    ...
    descripcion:
      "Refugio familiar en Xochimilco con enfoque en rescate callejero. Queremos conectar con familias adoptantes de toda la CDMX.",
  ...
  },
  {
    ...
    descripcion:
      "Operamos en el Centro Histórico de la CDMX desde hace 2 años. Rescatamos perros de las calles del centro y sus colonias aledañas. Necesitamos plataforma para crecer.",
...
export const getShelterListItem = (s: Shelter): ShelterListItem => ({
  ...
  status: s.status,
  perrosDisponibles: s.perrosDisponibles,
  adopcionesRealizadas: s.adopcionesRealizadas,
  calificacion: s.calificacion,
});

export const MOCK_SHELTERS_LIST: ShelterListItem[] =
  MOCK_SHELTERS.map(getShelterListItem);
