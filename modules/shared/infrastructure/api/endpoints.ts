...
export const API_ENDPOINTS = {
  ...
  DOGS: {
    ...
    DETAIL:       (id: number) => `${MS_DOGS}/dogs-ms/dogs/${id}`,
    BY_ID:        (id: string) => `${MS_DOGS}/dogs-ms/dog/${id}`,
    BY_SLUG:      (slug: string) => `${MS_DOGS}/dogs-ms/dog/slug/${slug}`,
    BY_SHELTER:   (id: string) => `${MS_DOGS}/dogs-ms/dogs/shelter/${id}`,
    CREATE:       `${MS_DOGS}/dogs-ms/dog`,
    UPDATE:       (id: string) => `${MS_DOGS}/dogs-ms/dog/${id}`,
    DELETE:       (id: string) => `${MS_DOGS}/dogs-ms/dog/${id}`,
    UPLOAD_MEDIA: `${MS_DOGS}/api/media/upload`,
  },
