...
const DROPDOWN_REFUGIO = [
  { href: '/refugio/perfil', label: 'Perfil del refugio', icon: 'manage_accounts' },
]
...
function TopBar() {
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(90deg, #fff4f4 0%, #fff8f5 35%, #fff4f8 70%, #f6f7ff 100%)',
      ...
      >
              ...
              return (
                <li key={item.label}>
                  ...
                  >
                    ...
                    {active && <span className="ml-auto w-1.5 h-1.5 rounded-full bg-[#ff6b6b] flex-shrink-0" />}
                  </Link>
                </li>
              )
            })}
        ...
        <div className="px-5 py-4 border-t border-[#f4f4f5] bg-[#fafafa] shrink-0">
          <div className="flex items-center justify-between">
            <p className="text-[11px] text-[#c4c4c7] font-[600]">© 2025 aDOGme · CDMX</p>
            <div className="flex items-center gap-3">
              <Link
                href="/terminos"
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="flex items-center h-[78px] gap-4">
              <Link href="/" className="flex items-center gap-3 shrink-0 group w-[220px]">
                <div
                ...
                {!user ? (
                  ...
                  <>
                    <div className="relative" ref={notifsRef}>
                      ...
                      {showNotifs && (
                        <div className="absolute right-0 top-11 w-80 bg-white border border-[#f0f0f0]
                          ...
                          <div className="flex items-center justify-between px-4 py-3 border-b border-[#f4f4f5]">
                            <span className="text-sm font-[700] text-[#18181b]">Notificaciones</span>
                            <span className="text-[10px] font-[700] px-2 py-0.5 rounded-full bg-[#fff5f5] text-[#ff6b6b]">3 nuevas</span>
                          </div>
                          <div className="divide-y divide-[#f4f4f5]">
                            {[
                              { icon: 'pets', color: '#ff6b6b', bg: '#fff5f5', title: 'Solicitud actualizada', desc: 'Tu solicitud para adoptar a Thor fue revisada.', time: 'hace 5 min' },
                              { icon: 'favorite', color: '#ec4899', bg: '#fdf2f8', title: 'Nuevo match', desc: 'Luna podría ser tu compañera ideal.', time: 'hace 1 h' },
                              { icon: 'chat', color: '#3b82f6', bg: '#eff6ff', title: 'Mensaje del refugio', desc: 'Huellitas MX te envió un mensaje.', time: 'hace 3 h' },
                            ].map((n, i) => (
                              <div key={i} className="flex items-start gap-3 px-4 py-3 hover:bg-[#fafafa] cursor-pointer transition-colors">
                                <div className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5"
                                     style={{ background: n.bg }}>
                                  <span className="material-symbols-outlined" style={{ fontSize: 16, color: n.color }}>
                                    {n.icon}
                                  </span>
                                </div>
                                <div className="flex-1 min-w-0">
                                  <p className="text-[13px] font-[600] text-[#18181b]">{n.title}</p>
                                  <p className="text-[12px] text-[#71717a] mt-0.5 leading-snug">{n.desc}</p>
                                  <p className="text-[11px] text-[#a1a1aa] mt-1">{n.time}</p>
                                </div>
                              </div>
                            ))}
                          </div>
