...
} from "./CompatibilityIcon";
import { EnergyBar, type EnergyLevel } from "./EnergyBar";
import {
  PersonalityTag,
  type PersonalityTag as PersonalityTagType,
} from "./PersonalityTag";
    ...
    >
      <div className="cat-dog-panel">
        ...
        <div className="cat-dog-body">
          ...
          {showShelterInfo && (
            <p className="cat-dog-shelter">{dog.shelterName}</p>
          )}
          ...
          <div className="cat-dog-infoList">
            ...
            <InfoRow
              icon={ENERGY_ICON[dog.nivelEnergia]}
              label="Energía"
              value={ENERGY_LABEL[dog.nivelEnergia]}
            />
            <InfoRow
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <span
              className={`cat-dog-badge ${badge.cls}`}
    ...
    <Link href={`/perros/${dog.id}`} className="cat-dog-frame group">
      <div className="cat-dog-panel">
        ...
        <div className="cat-dog-body">
          ...
          <p
            className="cat-dog-desc"
            style={{ WebkitLineClamp: 3, fontSize: "0.88rem" }}
          >
            {dog.descripcion}
          </p>
          <div
          ...
          >
            {[
              ...
              >
                <span
                  className="material-symbols-outlined"
                  style={{ fontSize: 15, color: "#ff6b6b" }}
                >
                  {s.icon}
                </span>
                {s.value}
    ...
    <>
      ...
      {variant === "compact" && (
        ...
        >
          ...
          >
            <div
              style={{ ...shimmerStyle, aspectRatio: "1/1", width: "100%" }}
            />
            <div
              style={{
                padding: "8px 10px",
