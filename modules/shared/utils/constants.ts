...
import type { AgeCategory, DogSize, DogStatus, EnergyLevel, PersonalityTag } from '../domain/Dog'
...
export const MAJOR_CITIES: string[] = [
  ...
  'León', 'Juárez', 'Querétaro', 'San Luis Potosí', 'Mérida',
  'Mexicali', 'Aguascalientes', 'Culiacán', 'Acapulco', 'Hermosillo',
  'Saltillo', 'Morelia', 'Veracruz', 'Cancún', 'Toluca',
  'Chihuahua', 'Torreón', 'Oaxaca', 'Villahermosa', 'Tuxtla Gutiérrez',
  'Ensenada', 'Los Cabos', 'Mazatlán', 'Puerto Vallarta', 'San Miguel de Allende',
]
...
export const PERSONALITY_TAGS_CATALOG: PersonalityTag[] = [
  ...
  { id: '8',  label: 'Sociable',           icon: 'pets',              categoria: 'socialización' },
  { id: '9',  label: 'Tímido',             icon: 'hide',              categoria: 'socialización' },
  { id: '10', label: 'Independiente',      icon: 'flight',            categoria: 'caracter' },
  { id: '11', label: 'Obediente',          icon: 'check_circle',      categoria: 'entrenamiento' },
  { id: '12', label: 'Terco',              icon: 'sentiment_neutral', categoria: 'entrenamiento' },
  { id: '13', label: 'Cariñoso',           icon: 'volunteer_activism',categoria: 'caracter' },
  { id: '14', label: 'Activo',             icon: 'directions_run',    categoria: 'actividad' },
  { id: '15', label: 'Instinto cazador',   icon: 'track_changes',     categoria: 'caracter' },
  { id: '16', label: 'Buen guardián',      icon: 'shield',            categoria: 'caracter' },
  { id: '17', label: 'Amigable',           icon: 'handshake',         categoria: 'socialización' },
  { id: '18', label: 'Nervioso',           icon: 'sentiment_worried', categoria: 'socialización' },
  { id: '19', label: 'Inteligente',        icon: 'psychology',        categoria: 'entrenamiento' },
