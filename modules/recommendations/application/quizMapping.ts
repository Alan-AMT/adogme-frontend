...
export function mapDraftToPayload(draft: QuizDraftState): QuizSubmitPayload {
  ...
  return {
    ...
    q7:  highest<Q7Option>(draft.q7Selected, Q7_RANKING as Record<Q7Option, number>),
    ...
    q20: highest<Q20Option>(draft.q20Selected, Q20_RANKING as Record<Q20Option, number>),
  }
}
...
export function isQuestionAnswered(q: QuizQuestionDef, draft: QuizDraftState): boolean {
  if (q.type === 'single') {
...
export function isBlockComplete(blockIndex: number, draft: QuizDraftState): boolean {
